                ...
                <div class="col-md-8">
                    ...
                    <div class="wrap__article-detail">
                        ...
                        <div class="wrap__article-detail-image mt-4">
                            <figure>
                                <img src="{{ asset($newsDetails->thumbnail) }}" alt="" class="img-fluid">
                            </figure>
                        </div>
                        <div class="wrap__article-detail-content">
                            <div class="total-views">
                                <div class="total-views-read">
                                    {{ convertNumberToKFormat($newsDetails->views) }}
                                    <span>
                                        {{ __('views') }}
                                    </span>
                                </div>
                        ...
                        <aside class="wrapper__list__article ">
                            ...
                            <div class="wrapper__list__article-small">
                                    ...
                                    <div class="card__post card__post-list">
                                        <div class="image-sm">
                                            <a href="{{ route('news.details',$news->slug) }}">
                                                <img src="{{ asset($news->thumbnail) }}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="{{ route('news.details',$news->slug) }}">
                                            <img src="{{ asset($news->thumbnail) }}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                                        ...
                                        <a href="{{ route('news.details',$news->slug) }}" class="btn btn-outline-primary mb-4 text-capitalize"> {{ __('read
                                            more') }}</a>
                                    </div>
                                </div>
                                @endif
